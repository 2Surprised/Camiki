...
const helpEmbed = new EmbedBuilder()
    ...
    .setColor('#ff57f6')
    .addFields(
        { name: 'Utility commands', value: '`/help`, `/ping`, `/user info`, `/user avatar`, `/role color view`, `/role color change`, `/file convert`' },
        { name: 'Fun commands', value: '`/apod`, `/insight`, `/birthday`, `/gemini`' }
    )
